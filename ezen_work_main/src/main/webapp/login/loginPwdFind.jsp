		...
		<fieldset class="searchWrap person">
			...
			<div class="searchForm">
				...
				<ul class="howtoTab person">
					...
					<li class="id">
						<div class="colWrap">
							<input type="email" id="userid_P" class="placeholder-input" name="find_id" value="" maxlength="300" placeholder="아이디">
						</div>
					</li>
					<li class="name">
						<div class="colWrap">
							<input type="text" id="usernm_P" class="placeholder-input" name="find_name" value="" maxlength="300" placeholder="이름">
						</div>
					</li>
					<li class="email">
						<div class="colWrap">
							<input type="text" id="htel_P" class="placeholder-input" name="find_email" value="" maxlength="110" placeholder="이메일">
						</div>
					</li>
				</ul>
				</form>
		...
		<fieldset class="searchWrap biz">
			...
			<div class="searchForm">
				<ul class="howtoTab biz">
					...
					<li class="name">
						<div class="colWrap">
							<input type="text" id="usernm_P" class="placeholder-input" name="find_cname" value="" maxlength="300" placeholder="이름">
						</div>
					</li>
					<li class="email">
						<div class="colWrap">
