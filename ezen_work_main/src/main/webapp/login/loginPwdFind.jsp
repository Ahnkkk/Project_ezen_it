...
</head><body id="PwdSearch" class="ALBA find" cz-shortcut-listen="true"><input type="hidden" id="device" name="device" value="">
...
<script src="/rsc/js/PwdSearchCLS.js?202105261330"></script>
...
<section id="Section" class="oldApp">
	<article id="Contents" class="pwdSearch memberSearch">
		...
		<!-- 개인회원 비밀번호 찾기 -->
		<form id="frmP" class="search-form person" name="frmP" method="post" action="">
		...
		<input type="hidden" id="howtoway_P" value="joininfo">
		<fieldset class="searchWrap person">
			...
			<div class="searchForm">
				<ul class="navTab">
					...
					<li id="CertInfoP" class="certinfo"><a href="#" onclick="PwdSearchCLS.changeTab('P', 'certinfo');return false">본인인증으로 찾기</a></li>
				</ul>
				<ul class="howtoTab person">
					<li class="joinInfo default">
						<span class="input first on"><input type="radio" id="howto_MOBILE_P" name="howto" value="MOBILE" onclick="PwdSearchCLS.changeHowToP();"><label for="howto_MOBILE_P">휴대폰</label></span>
						<span class="input"><input type="radio" id="howto_EMAIL_P" name="howto" value="EMAIL" onclick="PwdSearchCLS.changeHowToP();"><label for="howto_EMAIL_P">이메일</label></span>
					</li>
					...
					<li class="id">
						<div class="colWrap">
							<input type="email" id="userid_P" class="placeholder-input" name="userid" value="" maxlength="30">
							<label class="searchTitle" for="userid_P">아이디</label>
						</div>
					</li>
					<li class="name">
						<div class="colWrap">
							<input type="text" id="usernm_P" class="placeholder-input" name="usernm" value="" maxlength="30">
			...
			<div class="btnAction"><a href="#" onclick="PwdSearchCLS.doSearch('P');return false" class="btn btnType1">개인 비밀번호 찾기</a></div>
		</fieldset>
		</form>
		<!-- //개인회원 비밀번호 찾기 -->
		
		<!-- 기업회원 비밀번호 찾기 -->
		<form id="frmC" class="search-form" name="frmC" method="post" action="">
		...
		<fieldset class="searchWrap biz">
			...
			<div class="searchForm">
				<ul class="howtoTab biz">
					<li class="default">
						<span class="input first on"><input type="radio" id="howto_MOBILE_C" name="howto" value="MOBILE" checked="checked" onclick="PwdSearchCLS.changeHowToC()"><label for="howto_MOBILE_C">휴대폰 번호</label></span>
						<span class="input"><input type="radio" id="howto_IPIN_C" name="howto" value="IPIN" onclick="PwdSearchCLS.changeHowToC()"><label for="howto_IPIN_C">아이핀(i-PIN)인증</label></span>
					</li>
					<li class="id">
						<div class="colWrap">
							<input type="email" id="userid_C" class="placeholder-input" name="userid" value="" maxlength="30">
							<label class="searchTitle" for="userid_C">아이디</label>
						</div>
					</li>
					<li class="bizNo">
						<div class="colWrap">
					...
					<li class="name">
						<div class="colWrap">
							<input type="text" id="usernm_C" class="placeholder-input" name="usernm" value="" maxlength="30">
					...
					<li class="mobile">
						<div class="colWrap">
							...
							<label class="searchTitle" for="htel_C">휴대폰 (- 제외 번호 입력)</label>
			...
			<div class="btnAction"><a href="#" onclick="PwdSearchCLS.doSearch('C');return false" class="btn biz">기업 비밀번호 찾기</a></div>
		</fieldset>
		</form>
		<!-- //기업회원 비밀번호 찾기 -->
...
<script src="//trk.alba.co.kr/TA.js?202105261330"></script><div id="_BA"><img src="https://trk.alba.co.kr/Collect?servicetype=PCWEB&amp;logtype=VIEW&amp;cookieenabled=Y&amp;enctype=UTF-8&amp;scheme=https&amp;host=sign.alba.co.kr&amp;port=443&amp;pageurl=%2Fuser%2Ffind%2FPwdSearch.asp&amp;fullurl=https%3A%2F%2Fsign.alba.co.kr%2Fuser%2Ffind%2FPwdSearch.asp%3Fsite%3DWWW&amp;getdata=site%3DWWW&amp;referurl=https%3A%2F%2Fsign.alba.co.kr%2Flogin%2Flogingate.asp&amp;referparam=site%3DWWW%26gourl%3Dhttps%253A%252F%252Fwww%252Ealba%252Eco%252Ekr%252Fperson%252Fresume%252Fregist%252Easp%253Fformtype%253DNORMAL&amp;category1=%EC%95%8C%EB%B0%94%EC%B2%9C%EA%B5%AD%2C%20%EC%93%B8%EC%88%98%EB%A1%9D%20%EC%B2%9C%EA%B5%AD&amp;osversion=&amp;cid=6E2BD498E7F94A788347D1440DCB981A" width="1" height="1" style="display:none" alt=""></div>
<script>
